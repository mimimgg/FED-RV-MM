...
/********************************************************** 
  ...
  6. 컴포넌트에서 속성받기
    (1) 속성명을 하나만 쓸 경우 :  props.속성명
    (2) 속성명 구조분해 할당으로 직접쓸 경우
      {변수명,변수명,...}
      -> 보내준 속성명과 같은 이름의 변수로 설정함!

      (( 구조분해할당으로 받을 경우의 장점 ))
      특정 속성명을 지정하는 효과가 있어서 컴포넌트 호출시에 이 이름으로 속성명을 설정하며 몇개의 어떤 속성을 받는지 개발자가 명시적으로 알 수 있다!
**********************************************************/
