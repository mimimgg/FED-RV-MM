...
function EventShow (){
  ...
  const showAladin = () => {
    ...
    // 2. 알라딘 이미지 출력하기
    // (1) html 출력대상 : #ala
    let alaBox = document.querySelector("#ala");
    ...
    // 3. 말풍선 박스에 글자넣기 ///
    let titBox = document.querySelector(".tit");
  ...
  const getLamp = () => {
    ...
    // 1. 램프선택하기 : .lamp
    let lampBox = document.querySelector(".lamp");
...
function moveCar(eleName) {
  ...
  // 1. 대상요소 셋팅하기
  const tg = document.querySelector(eleName).style;
