...
// console.log('문자값배열 원본', arrString);
// console.log('문자값배열 원본+sort', arrString.sort());
// console.log('문자값배열 원본+reverse', arrString.reverse());

// // 숫자가 아니면 빼기 연산을 할 수 없음
// console.log('문자값배열 원본+sort((a,b) => a-b):', 
//     arrString.sort((a,b) => a-b));
// console.log('문자값배열 원본+sort((a,b) => b-a):', 
...
/**************************************************************** 
    ...
    -> 즉, 비교연사자를 사용한다
    1. 같다 : 0 / 변경없음
    2. 음수 : 음수(마이너스) / 그대로 순서유지
    3. 양수 : 양수(플러스) / 양쪽을 바꿔서 유지
...
const showFumFn = () => {
    showNum.innerHTML = arrNumber.map(v => `
        <img src="./images/num/num_0${v}.png" alt="숫자 이미지">
    `).join('');
};
