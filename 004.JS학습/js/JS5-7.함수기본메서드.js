...
// 출력 코딩구역 //////////////////
  ...
  exBox[4].innerText = 힘내.call({호호:"게르니카", 하하:"우는여인"},"피카소")
  ...
  // 두의 배열만 필요하고 이것을 보내서 최대값/최소값을 리턴함

  // 단순배열
  const myNum = [2400, 3600, 4200, 5300, 6700];
  console.log(myNum,"의 최대값:", Math.max.apply(null,myNum));
  ...
  // -> bind(객체)()는 객체를 묶어보내는 역할만 하고 실행 뒤에 소괄호함
