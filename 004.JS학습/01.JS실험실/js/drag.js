...
// goDrag : 일반함수
// GoDrag : 생성자함수
// -> 차이 : 생성자함수는 new 키워드로 호출해야 한다.
// -> 생성자함수를 new키워드로 호출하면 인스턴스가 생성됨
// -> 일반함수와의 차이 : 같은 코드를 이용한 메모리카피를 통해 소스가 확장되는 반면 생성자함수는 인스터느를 생성해서 마치 한대의 핸드폰으로 처리하던 일을 각 사람에게 핸드폰을 구매하여 각각처리하는 것처럼 메모리공간을 독립시켜 프로세스를 처리한다고 볼 수 있음
